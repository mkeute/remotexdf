# Authors: Marius Keute
# modified after https://github.com/xdf-modules/pyxdf
#
...
def load_remotexdf(f,
    ...
    Args:
        f : filehandle of remote file (e.g., instance of paramiko.SFTPFile)

        select_streams : defunct
...
if __name__ == "__main__":
    ...
    client.connect( hostname = '123.4.567.000', username = 'your_username', key_filename='/path/to/keyfile')
    ...
    f = sftpclient.open(xdf_example, 'rb')
    f.prefetch()
